  ...
  <?php require 'includes/adminNav.php';?>
    ...
    <form action="../handler/updateuser.php" class="mt-5  mx-auto row" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3 col-12">
            ...
            <input type="text" class="form-control" name="name" value="<?php echo $user['name'] ?>" id="nameInput">
            <small id="nameError" class="form-text text-danger"> </small>
        </div>
        <div class="mb-3 col-12 col-md-6">
            <label for="exampleFormControlInput1" class="form-label">Email address</label>
            <input type="email" class="form-control" name="email" value="<?php echo $user['email'] ?>" id="emailInput" placeholder="name@example.com">
            <small id="emailError" class="form-text text-danger "></small>
        </div>
        <div class="mb-3 col-12 col-md-6">
            <label for="exampleFormControlInput3" class="form-label">password </label>
            <input type="password" class="form-control" name="password" value="<?php echo $user['password'] ?>" id="passwordInput" required>
        ...
        <div class="mb-3 col-12 col-md-6">
            ...
            <input type="number" name="phone" value="<?php echo $user['phone'] ?>" class="form-control" id="phoneInput" required>
        ...
        <div class="mb-3 col-12 col-md-6">
            ...
            <select class="form-select" name="room" aria-label="Default select example">
                <option value="<?php echo $user['room'] ?>" selected><?php echo $user['room'] ?></option>
        ...
        <div class="mb-3 col-12 col-md-6">
            ...
            <input type="hidden" name="old_img" value="<?php echo $user['image']; ?>" readonly >


            <img src="../images/user_images/<?php echo $user['image'] ?>" class="rounded-circle" alt="" width="100" height="100">

            <small id="fileError" class="form-text text-danger "></small>
        </div>
        <input type="hidden" class="form-control" id="updatetype"  name="user_id" value="<?php echo $user['id']; ?>"readonly>

        </div>
        <div class="mb-3 text-center">
            <button type="submit" name='update' class=" mt-3  w-25">Save Changes</button>
        </div>
    </form>
    <script>
        let valid = true;
